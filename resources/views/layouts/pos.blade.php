...
<head>
    ...
    <title>@yield('title', 'Punto de Venta') — {{ $perfilNegocio->tituloWeb() ?? config('rentaltech.empresa.razon_social') }}</title>
...
<header class="pos-cab">
    ...
    <div class="pos-cab-info">
        ...
        {{-- Cada rol tiene su propia ruta de inicio (admin.index, secretaria.index,
             ventas.index) — nunca admin.index fijo, que rompía (403) para
             cualquiera que no fuera admin. --}}
