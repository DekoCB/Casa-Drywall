{{--
    Layout de los paneles con acceso limitado (secretaría y contabilidad).
    Comparte el mismo shell del panel administrativo, pero el menú lo define
    cada vista mediante la sección `menu`.
--}}
<!DOCTYPE html>
<html lang="es">
<head>
