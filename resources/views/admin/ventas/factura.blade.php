...
.nv-chip { padding: 1px 7px; border-radius: 20px; background: var(--brand-bg); color: var(--brand); font-size: 10px; font-weight: 700; }
...
fIncluyeIgv?.addEventListener('change', async () => {
